...
export const ui: Record<Lang, Record<string, string>> = {
  ne: {
    ...
    "chart.count": "संख्या",
    "chart.percentage": "प्रतिशत",
    "chart.male": "पुरुष",
    "chart.female": "महिला",
    "chart.total": "जम्मा",
    "chart.unknown": "अज्ञात",
    "chart.ward": "वडा",
    "chart.population": "जनसंख्या",
    "chart.others": "अन्य",
  },
  en: {
  ...
  },
  {
    ...
    sections: [
      { id: "4-1", slug: "major-economic", title: { ne: "प्रमुख आर्थिक विवरण", en: "Major Economic Description" }, children: [
        { id: "4-1-1", slug: "industrial-sector-population", title: { ne: "४.१.१ आर्थिक कामको औद्योगिक क्षेत्र वर्गीकरण अनुसारको जनसंख्या", en: "4.1.1 Population by Economic and Industrial Sector" } },
        { id: "4-1-2", slug: "housing-structure", title: { ne: "४.१.२ आवास संरचना विवरण", en: "4.1.2 Housing Structure Description" } },
        { id: "4-1-3", slug: "import-export", title: { ne: "४.१.३ आयात तथा निर्यातको अवस्था", en: "4.1.3 Import Export Status" } },
        { id: "4-1-4", slug: "raw-material-production", title: { ne: "४.१.४ औद्योगिक कच्चा पदार्थ उत्पादनको अवस्था", en: "4.1.4 Industrial Raw Material Production" } },
        { id: "4-1-5", slug: "foreign-employment", title: { ne: "४.१.५ वैदेशिक रोजगारीमा गएकाहरूको विवरण", en: "4.1.5 Foreign Employment Description" } },
        { id: "4-1-6", slug: "sukumbasi", title: { ne: "४.१.६ सुकुम्बासी सम्बन्धी विवरण", en: "4.1.6 Sukumbasi Related Description" } },
      ]},
      { id: "4-2", slug: "land-use-ownership", title: { ne: "४.२ भू-उपयोग तथा स्वामित्व", en: "4.2 Land Use and Ownership" }, children: [
        { id: "4-2-1", slug: "land-use-distribution", title: { ne: "४.२.१ भू-उपयोगको वितरण", en: "4.2.1 Land Use Distribution" } },
        { id: "4-2-2", slug: "cultivable-land", title: { ne: "४.२.२ खेतीयोग्य जमिन सम्बन्धी विवरण", en: "4.2.2 Cultivable Land Description" } },
        { id: "4-2-3", slug: "barren-land", title: { ne: "४.२.३ बाँझो जमिन सम्बन्धी विवरण", en: "4.2.3 Barren Land Description" } },
      ]},
      { id: "4-3", slug: "agriculture-animal-development", title: { ne: "४.३ कृषि तथा पशु विकास", en: "4.3 Agriculture and Animal Development" } },
      { id: "4-4", slug: "agricultural-family", title: { ne: "४.४ कृषिक परिवार संख्या, क्षेत्रफल, कित्ता संख्या तथा सिंचित क्षेत्रफल", en: "4.4 Agricultural Family, Area, Parcel and Irrigated Area" } },
      { id: "4-5", slug: "land-consumption", title: { ne: "४.५ जग्गाको उपभोग सम्बन्धी विवरण", en: "4.5 Land Consumption Description" } },
      { id: "4-6", slug: "agricultural-land-use", title: { ne: "४.६ कृषि जग्गाको उपयोग सम्बन्धी विवरण", en: "4.6 Agricultural Land Use Description" }, children: [
        { id: "4-6-1", slug: "food-crop-diseases", title: { ne: "४.६.१ खाद्यान्न बालीमा लाग्ने रोग तथा किरा", en: "4.6.1 Diseases and Pests in Food Crops" } },
        { id: "4-6-2", slug: "vegetable-fruit-diseases", title: { ne: "४.६.२ तरकारी तथा फलफूलमा लाग्ने रोग तथा किरा", en: "4.6.2 Diseases and Pests in Vegetables and Fruits" } },
        { id: "4-6-3", slug: "livestock-diseases", title: { ne: "४.६.३ पशुपक्षीमा लाग्ने रोग तथा किरा", en: "4.6.3 Diseases in Livestock" } },
        { id: "4-6-4", slug: "commercial-agriculture", title: { ne: "४.६.४ व्यवसायिक कृषि तथा पशुपालन कमहरूको विवरण", en: "4.6.4 Commercial Agriculture and Animal Husbandry" } },
        { id: "4-6-5", slug: "agriculture-groups", title: { ne: "४.६.५ कृषि तथा पशुपालनसँग सम्बन्धित समूह तथा सामुदायिक संस्थाको विवरण", en: "4.6.5 Agriculture and Animal Husbandry Groups" } },
        { id: "4-6-6", slug: "collection-chilling-center", title: { ne: "४.६.६ संकलन केन्द्र तथा चिस्यान केन्द्र", en: "4.6.6 Collection and Chilling Center" } },
      ]},
